                                                    ...
                                                    <div class="H8mXLe">
                                                        <div class="n-CE6j -rN11Y">
                                                            <div class="-rN11Y edy5hG"
                                                                 style="background-image: url(<?php echo get_stylesheet_directory_uri() ?>/img/danhmuc/<?php echo $catUp['img'] ?>); background-size: contain; background-repeat: no-repeat;"></div>
                                                        </div>
                                                    </div>
                                                    <div class="cZdsLQ">
                                               ...
                                               href="#">
                                                <div class="_1l+Pw-">
                                                    <div class="H8mXLe">
                                                        <div class="n-CE6j -rN11Y">
                                                            <div class="-rN11Y edy5hG"
                                                                 style="background-image: url(<?php echo get_stylesheet_directory_uri() ?>/img/danhmuc/<?php echo $catDown['img'] ?>); background-size: contain; background-repeat: no-repeat;"></div>
                                                        </div>
                                                    </div>
                                                    <div class="cZdsLQ">
                            ...
                            <div class="uA1waf _4QQ4Ir">
                                <div style="pointer-events: none;">
                                    <div class="n-CE6j iR+sxV">
                                        <img alt="<?php $product['label'] ?>"
                                             class="Vz6gJ3 edy5hG"
                                             style="object-fit: contain"
                                             src="<?php echo get_stylesheet_directory_uri() ?>/img/product/<?php echo $product['img'] ?>">
                                        <div class="X5j9y1">
                                ...
                                <div class="W3bJfG">
                                    ...
                                    <div class="imdVqB _2fuFWg">
                                        <div class="WSVId4 fepoRf"><span class="j0vBz2">69.000</span></div>
                                        <div class="upl8wJ _82UoSS">Đã bán 1,1k</div>
                                    </div>
                                </div>
