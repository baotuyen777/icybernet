<?php
const FREESHIP = '<svg viewBox="0 0 20 12" height="12" width="20"
                                                     class="freeship">
                                                    <path fill="#00bfa5"
...
const CART = ' <svg enable-background="new 0 0 15 15" viewBox="0 0 15 15" x="0" y="0"
...
const CHAT = '<svg     x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" class="shopee-svg-icon">
