                ...
                <div class="PuXQrZ">
                    ...
                    <div class="pkg67p">
                        <a target="_blank" rel="noopener noreferrer" href="/web/">
                            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/icon/qrcode.png" alt="download_qr_code" class="qrcode">
                        </a>
                        <div class="zLPzwH">
...
<div id="shopee-mini-chat-embedded" style="position: fixed; right: 8px; bottom: 0px; z-index: 99999;">
    <div class="src-pages-Entry-index__root--1G_Ox">
        <div class="src-pages-Entry-index__logo-wrapper--IqLfz"><i
                    class="_3kEAcT1Mk5 src-pages-Entry-index__chat--3rr3d">
            ...
            </i><i class="_3kEAcT1Mk5 src-pages-Entry-index__logo--2m8Mr">
