...
<div id="main">
    <div>
        ...
        <div style="display: contents;">
            <div class="xCao3k N2AB73">
                <div class="home-page">
                    <div class="shopee-floating-icons__wrapper" style="left: 1580px;"></div>
                        ...
                        <div class="full-home-banners-wrapper">
                            <div class="container">
                                <div class="full-home-banners">
                                                ...
                                                <ul class="stardust-carousel__item-list">
                                                    <li class="stardust-carousel__item" style="width: 100%;">
                                                        <div class="stardust-carousel__item-inner-wrapper stardust-carousel__item-inner-wrapper--hide">
                                                            <a
                                                                    class="full-home-banners__banner-image"
                                                                ...
                                                                <div class="n-CE6j full-home-banners__light-background">
                                                                    <div class="full-home-banners__main-banner-image edy5hG"
                                                                         style="background-image: url('img/banner/banner1.jpg'); background-size: cover; background-repeat: no-repeat;"></div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </li>
                                    ...
                                    <div class="full-home-banners__right-wrapper"><a
                                                class="full-home-banners__right-banner"
                                                href="/m/dat-do-an-online-shopeefood">
                                            ...
                                            <div class="n-CE6j full-home-banners__full-height full-home-banners__light-background">
                                                <div class="full-home-banners__right-banner-image edy5hG"
                                                     style="background-image: url(img/banner/banner2.jpg); background-size: cover; background-repeat: no-repeat;"></div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="xZ4bbg">
                                <?php
                                $arrCat1 = [
                                    ['label' => 'Săn Sale', 'img' => 'flash_sale.gif'],
                                    ['label' => 'Hàng thanh lý', 'img' => 're.png'],
                                    ['label' => 'Miễn phí vận chuyển', 'img' => 'freeship.png'],
                                    ['label' => 'Giảm giá shock', 'img' => 'giasoc.png'],
                                    ['label' => 'Hoàn xu', 'img' => 'hoanxu.png'],
                                    ['label' => 'Hàng hiệu giá tốt', 'img' => 'hanghieu.png'],
                                    ['label' => 'Hàng xách tay', 'img' => 'hangxachtay.png'],
                                    ['label' => 'Hàng cao cấp', 'img' => 'hangcaocap.png'],
                                            ...
                                            <div class="_2Ehn-F ybDQTz">
                                                <div class="n-CE6j dNmwQY">
                                                    <div class="_5l6amx edy5hG"
                                                         style="background-image: url(img/<?= $cat['img'] ?>); background-size: contain; background-repeat: no-repeat;"></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="shopee-header-section shopee-header-section--simple">
                                        <div class="shopee-header-section__header">
                                                    ...
                                                    <div class="_0+e+wK">
                                                        ...
                                                        <div class="shopee-countdown-timer Esi0xY">
                                                            <div class="shopee-countdown-timer__number">
                                                                <div class="shopee-countdown-timer__number__hexa shopee-countdown-timer__number__hexa--hour"
                                                                     style="animation-delay: -389478s;">
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 41.701 69.001" role="img"
                                                                    ...
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 43.503 67.701" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                                                  stroke-linecap="round"
                                                                                  stroke-width=".945"
                                                                    ...
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 43.204 69.004" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                                                  stroke-linecap="round"
                                                                                  stroke-width=".945"
                                                                    ...
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 39.5 66.3" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                                                  stroke-linecap="round"
                                                                                  stroke-width=".945"
                                                                                  d="M21.6 11.6L0 66.3h13.3L39.5 0H.1v11.6h21.5z"></path>
                                                                        </svg>
                                                                    </div>
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 43.402 67.6" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                                                  stroke-linecap="round"
                                                                                  stroke-width=".945"
                                                                    ...
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 42.8 67.6" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                                                  stroke-linecap="round"
                                                                                  stroke-width=".945"
                                                                    ...
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 42.9 66.9" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                                                  stroke-linecap="round"
                                                                                  stroke-width=".945"
                                                                                  d="M24.5 53.2v13.7h12.3V53.2h6.1v-11h-6.1V0H23.4L0 42.5v10.7h24.5zm0-11h-14l14-24.8v24.8z"></path>
                                                                        </svg>
                                                                    </div>
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 43 67" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                                                  stroke-linecap="round"
                                                                                  stroke-width=".945"
                                                                    ...
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 42.3 67.703" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                                                  stroke-linecap="round"
                                                                                  stroke-width=".945"
                                                                    ...
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 25 68.1" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                                                  stroke-linecap="round"
                                                                                  stroke-width=".945"
                                                                                  d="M12.1 18.4v49.7H25V0L0 13v11.9l12.1-6.5z"></path>
                                                                        </svg>
                                                                    </div>
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 41.701 69.001" role="img"
                                                                ...
                                                                <div class="shopee-countdown-timer__number__deca shopee-countdown-timer__number__deca--hour"
                                                                     style="animation-delay: -33078s;">
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 41.701 69.001" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                            ...
                                                            <div class="shopee-countdown-timer__colon shopee-countdown-timer__colon--flashing-off">
                                                                <div class="colon-dot__wrapper"><span
                                                                            class="colon-dot"></span></div>
                                                                <div class="colon-dot__wrapper"><span
                                                                            class="colon-dot"></span></div>
                                                            </div>
                                                            <div class="shopee-countdown-timer__number">
                                                                <div class="shopee-countdown-timer__number__hexa shopee-countdown-timer__number__hexa--minute"
                                                                     style="animation-delay: -1278s;">
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 41.701 69.001" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                                ...
                                                                <div class="shopee-countdown-timer__number__deca shopee-countdown-timer__number__deca--minute"
                                                                     style="animation-delay: -138s;">
                                                                    <div class="shopee-countdown-timer__number__item">
                                                                        <svg viewBox="0 0 41.701 69.001" role="img"
                                                                             class="stardust-icon stardust-icon-zoom">
                                                                            <path fill-rule="evenodd"
                                                            ...
                                                            <div class="shopee-countdown-timer__number">
                                                                <div class="shopee-countdown-timer__number__hexa shopee-countdown-timer__number__hexa--second"
                                                                ...
                                                                <div class="shopee-countdown-timer__number__deca shopee-countdown-timer__number__deca--second"
                                            ...
                                            <a class="shopee-header-section__header-link" tabindex="-1"
                                               href="/flash_sale?promotionId=110875692490752">
...
<!--                                                </div>-->
                            ...
                            <div class="xoClEI"></div>
                            <div style="margin-top: 20px;">
                                <shopee-vertical-stack-ui max="1" ratio="10.909091"></shopee-vertical-stack-ui>
                            </div>
                            ...
                            <div class="section-recommend-products-wrapper">
                                <div>
                                    <div class="ARwPBS">
                                        ...
                                        <nav class="stardust-tabs-header-wrapper" style="top: 7.375rem;">
                                            ...
                                            <section class="stardust-tabs-panels__panel" style="display: block;">
                                                <div class="_6wTCb6">
                                                    ...
                                                    <div class="qqV7Rl"><a
                                                                ...
                                                                href="/daily_discover?pageNumber=2">Xem thêm</a></div>
                                                </div>
                                            </section>
                    ...
                    <shopee-banner-popup-stateful spacekey="PC-VN-HOME_POPUP_01"></shopee-banner-popup-stateful>
                </div>
            </div>
        </div>
